$(function()
{
	...
	$('#leave_comment').click(function(e){
		...
		var captcha = $('#block_comments_form #securityCode').val();

		$.post(intelli.config.ia_url + 'comments.json', {action: 'add', author: author, item: item, email: email, url: url, body: body, prevent_csrf: prevent_csrf, item_id: item_id, security_code: captcha}, function(data)
		{
