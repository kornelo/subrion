{if isset($portfolio_entry)}
	<div class="media ia-item portfolio-entry">
		<p class="ia-item-date">{lang key='posted_on'} {$portfolio_entry.date_added|date_format:$config.date_format}</p>
...
{else}
	{if $portfolio_entries}
		...
		{navigation aTotal=$pagination.total aTemplate=$pagination.template aItemsPerPage=$config.portfolio_entries_per_page  aNumPageItems=5}
	{else}
